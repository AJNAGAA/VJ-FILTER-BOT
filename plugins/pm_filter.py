...
async def pm_text(bot, message):
    ...
    if PM_SEARCH == True:
        ...
        await message.reply_text(text=f"<b>ʜᴇʏ {user} 😍 ,\n\nʏᴏᴜ ᴄᴀɴ'ᴛ ɢᴇᴛ ᴍᴏᴠɪᴇs ꜰʀᴏᴍ ʜᴇʀᴇ. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ <a href=https://t.me/zenzlm>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇</b>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/zenzlm")]]))
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # don't change anything without contacting me @kingvj01
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(f"Tʜɪs Bᴏᴛ Is A Oᴘᴇɴ Sᴏᴜʀᴄᴇ Pʀᴏᴊᴇᴄᴛ\n\nWɪᴛʜ Aʟʟ Tʜᴇ Lᴀᴛᴇsᴛ Aɴᴅ Aᴅᴠᴀɴᴄᴇᴅ Fᴇᴀᴛᴜʀᴇs\n\nIғ Yᴏᴜ Wᴀɴᴛ Tʜɪs Tʏᴘᴇ Oғ Bᴏᴛ Cᴏɴᴛᴀᴄᴛ <a href=https://telegram.me/zencontbot>Cᴏɴᴛᴀᴄᴛ Mᴇ</a>",
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )
